...
class UserNarrativeState(Base):
    ...
    # FIX: Relación correcta con UserDecision usando user_id como ForeignKey
    decisions = relationship(
        "UserDecision",
        back_populates="user_state",
        lazy="selectin",
        primaryjoin="UserNarrativeState.user_id==UserDecision.user_id"
    )
...
class UserDecision(Base):
    ...
    # FIX: Relación correcta con UserNarrativeState usando user_id
    user_state = relationship(
        "UserNarrativeState",
        back_populates="decisions",
        primaryjoin="UserDecision.user_id==UserNarrativeState.user_id"
    )
